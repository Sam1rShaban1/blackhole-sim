...
/* package blackhole-0.1.0.0 */
#ifndef VERSION_blackhole
#define VERSION_blackhole "0.1.0.0"
#endif /* VERSION_blackhole */
#ifndef MIN_VERSION_blackhole
#define MIN_VERSION_blackhole(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_blackhole */
...
#define CURRENT_COMPONENT_ID "blackhole-0.1.0.0-inplace-blackhole"
